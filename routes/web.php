...
Route::get('/user/profile/', [HomeController::class, 'view_profile'])->name('view.profile');
Route::put('/user/profile/update', [HomeController::class, 'update_profile'])->name('update.profile');
